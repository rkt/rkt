...
This will build the rkt binary and the stage1-fly.aci in `build-rkt-1.26.0+git/bin/`.
...
```
# rkt run --stage1-name=coreos.com/rkt/stage1-fly:1.26.0 coreos.com/etcd:v2.2.5
```
