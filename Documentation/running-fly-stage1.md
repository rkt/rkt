...
This will build the rkt binary and the stage1-fly.aci in `build-rkt-1.27.0+git/bin/`.
...
```
# rkt run --stage1-name=coreos.com/rkt/stage1-fly:1.27.0 coreos.com/etcd:v2.2.5
```
