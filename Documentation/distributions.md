...
wget https://github.com/rkt/rkt/releases/download/v1.27.0/rkt-1.27.0-1.x86_64.rpm
wget https://github.com/rkt/rkt/releases/download/v1.27.0/rkt-1.27.0-1.x86_64.rpm.asc
gpg --verify rkt-1.27.0-1.x86_64.rpm.asc
sudo rpm -Uvh rkt-1.27.0-1.x86_64.rpm
```
...
wget https://github.com/rkt/rkt/releases/download/v1.27.0/rkt_1.27.0-1_amd64.deb.asc
gpg --verify rkt_1.27.0-1_amd64.deb.asc
