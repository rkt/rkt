...
UFS_SYSTEMDDIR_BASE := $(BUILDDIR)/tmp/usr_from_src
UFS_SYSTEMDDIR_REST := systemd/$(call escape-for-file,$(UFS_SYSTEMD_DESC))
UFS_SYSTEMDDIR := $(UFS_SYSTEMDDIR_BASE)/$(UFS_SYSTEMDDIR_REST)
...
CREATE_DIRS += \
	$(call dir-chain,$(UFS_SYSTEMDDIR_BASE),$(UFS_SYSTEMDDIR_REST))
CLEAN_FILES += \
