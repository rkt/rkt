...
const (
	manifestOSArchTemplate = `{"acKind":"ImageManifest","acVersion":"0.7.3","name":"IMG_NAME","labels":[{"name":"version","value":"1.0.0"}ARCH_OS],"app":{"exec":["/inspect", "--print-msg=HelloWorld"],"user":"0","group":"0","workingDirectory":"/"}}`
)
