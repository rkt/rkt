...
const (
	noappManifestStr = `{"acKind":"ImageManifest","acVersion":"0.7.4","name":"coreos.com/rkt-inspect","labels":[{"name":"version","value":"1.5.0"},{"name":"arch","value":"amd64"},{"name":"os","value":"linux"}]}`
)
