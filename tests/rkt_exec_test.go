...
const (
	noappManifestStr = `{"acKind":"ImageManifest","acVersion":"0.8.9","name":"coreos.com/rkt-inspect","labels":[{"name":"version","value":"1.19.0"},{"name":"arch","value":"amd64"},{"name":"os","value":"linux"}]}`
)
