...
const (
	noappManifestStr = `{"acKind":"ImageManifest","acVersion":"0.8.7","name":"coreos.com/rkt-inspect","labels":[{"name":"version","value":"1.17.0"},{"name":"arch","value":"amd64"},{"name":"os","value":"linux"}]}`
)
