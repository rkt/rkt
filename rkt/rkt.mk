...
BGB_GO_FLAGS := $(strip -ldflags "$(RKT_STAGE1_DEFAULT_NAME_LDFLAGS) $(RKT_STAGE1_DEFAULT_VERSION_LDFLAGS) $(RKT_STAGE1_DEFAULT_LOCATION_LDFLAGS) $(RKT_VERSION_LDFLAGS) $(RKT_FEATURES_LDFLAGS)" $(RKT_TAGS))
