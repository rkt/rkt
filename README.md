...
![Rocket Logo](logos/rkt-horizontal-color.png)
...
```
wget https://github.com/coreos/rocket/releases/download/v0.5.2/rocket-v0.5.2.tar.gz
tar xzvf rocket-v0.5.2.tar.gz
cd rocket-v0.5.2
./rkt help
```
